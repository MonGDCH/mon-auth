 ...
 * @version 1.0.0
 */
class DbAccessTokenCommand extends Command
{
    /**
     * 指令名
     *
     * @var string
     */
    protected static $defaultName = 'dbAccessToken:publish';
     ...
     * @var string
     */
    protected static $defaultDescription = 'Publish the access token database.';
    ...
    public function execute(Input $in, Output $out)
    {
        ...
        $content = $content[0];
        // 表名
        $table = Config::instance()->get('auth.accesstoken.dao.construct.table', 'api_sign');
        // 建表sql
